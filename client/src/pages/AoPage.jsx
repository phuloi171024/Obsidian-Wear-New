...
export default function AoPage() {
  ...
  useEffect(() => {
    const fetchFilteredProducts = async () => {
      try {
        setLoading(true);
        // Đổi danh mục thành Áo
        const filters = { category: "Áo", sort: sortOption };
      ...
      <div className="product-page">
        ...
        <section className="product-content">
          ...
          <div className="breadcrumb">
            <span>Trang chủ</span><span className="arrow"> &gt; </span><span className="active">Áo</span>
          </div>
          ...
          {loading ? (
            ...
            <div className="shop-product-grid">
              {products.length > 0 ? (
                ...
                <p style={{ textAlign: "center", color: "#777", gridColumn: "1 / -1", padding: "40px" }}>Không tìm thấy sản phẩm áo phù hợp.</p>
              )}
            </div>
          )}
        </section>
