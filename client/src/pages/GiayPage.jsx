...
export default function GiayPage() {
  const giayProducts = products.filter((p) => p.category === "Giày");
      ...
      <div className="product-page">
        ...
        <section className="product-content">
          ...
          <div className="breadcrumb">
            ...
            <span className="active">Giày</span>
          </div>

          <div className="shop-product-grid">
            {giayProducts.length > 0 ? (
              giayProducts.map((product) => (
                <ProductCard key={product.id} product={product} />
              ))
            ) : (
              <p>Không có sản phẩm nào thuộc danh mục Giày.</p>
            )}
          </div>
        </section>
      </div>
